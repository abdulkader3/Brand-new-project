...
import ProfileRightSide from "../Profile/ProfileRightSide";
    ...
    <>
      ...
      <div className="hidden lg:flex w-full h-screen bg-[#ffffffc7]">
        ...
        <div className="flex-1 flex flex-col relative bg-gray-50">
          ...
          {/* Messages Area */}
          <div className="flex-1 flex flex-col gap-6 overflow-y-auto overflow-x-hidden px-8 py-6 mobile-safe-bottom" style={{WebkitOverflowScrolling: 'touch'}}>
      ...
      <div className="lg:hidden w-full h-screen bg-[#ffffffc7] relative pt-5 overflow-hidden flex flex-col">
        ...
        {/* Textarea */}
        <div
          className="w-full fixed left-0 bottom-16 md:bottom-20 lg:bottom-24 xl:bottom-28 flex items-center px-5 md:px-8 lg:px-12 xl:px-16 bg-white rounded-2xl shadow-[0px_2px_8px_5px_rgba(0,_0,_0,_0.1)] mobile-button-safe"
          style={{ zIndex: 49 }}
        >
