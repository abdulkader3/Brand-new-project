...
// Customer will decide what they want 
  ...
  return (
    <>
      ...
      <div className="hidden lg:flex w-full h-screen bg-[#ffffffc7]">
        ...
        <div className="flex-1 flex flex-col bg-gray-50">
          ...
          <div className="flex-1 flex flex-col lg:flex-row lg:gap-8 lg:px-8 lg:py-6">
            ...
            {/* Right Column - Coupon & Totals (Desktop: 1/3 width) */}
            <div className="lg:flex-[1] lg:sticky lg:top-24 lg:self-start">
              {/* Coupon Section */}
              <div className="px-4 md:px-6 lg:px-6 py-6 bg-white lg:rounded-2xl lg:shadow-sm lg:border lg:border-gray-100 lg:mb-6">
                ...
                <div className="space-y-4">
                  ...
                  <button className="w-fit bg-green-500 text-white py-4 px-6 rounded-xl font-semibold text-lg hover:bg-green-600 transition-colors shadow-sm">
                    APPLY COUPON
                  </button>
                </div>
              </div>
              ...
              {/* Cart Total Section */}
              <div className="px-4 md:px-6 lg:px-6 py-6 bg-gray-50 lg:bg-white lg:rounded-2xl lg:shadow-sm lg:border lg:border-gray-100">
      ...
      <div className="lg:hidden w-full min-h-screen bg-gray-50 relative flex flex-col max-w-7xl mx-auto">
        {/* Header */}
